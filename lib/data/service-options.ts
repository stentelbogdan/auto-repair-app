...
export const carPartDetails: ServiceDetailOption[] = [
...
export const damageKindDetails: ServiceDetailOption[] = [
...
export const detailingInteriorDetails: ServiceDetailOption[] = [
  {
...
export const detailingExteriorDetails: ServiceDetailOption[] = [
  {
...
export const SERVICE_OPTION_GROUPS: Partial<
  Record<string, ServiceOptionGroupDefinition[]>
> = {
  scratch: [
    {
