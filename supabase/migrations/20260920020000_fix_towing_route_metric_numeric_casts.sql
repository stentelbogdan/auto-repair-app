...
begin
  ...
  insert into public.repair_requests (
    ...
    round(nullif(p_request ->> 'route_distance_meters', '')::numeric)::integer,
    round(nullif(p_request ->> 'route_duration_seconds', '')::numeric)::integer,
...
begin
  ...
  update public.repair_requests set
    ...
    route_distance_meters = round(nullif(p_update ->> 'route_distance_meters', '')::numeric)::integer,
    route_duration_seconds = round(nullif(p_update ->> 'route_duration_seconds', '')::numeric)::integer,
