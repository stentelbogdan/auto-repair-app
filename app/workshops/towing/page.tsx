...
export default function WorkshopTowingPage() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel("workshop-towing-repair-request-updates")
      .on(
        "postgres_changes",
        {
          event: "UPDATE",
      ...
      .subscribe((status, error) => {
        if (process.env.NODE_ENV === "development" && error) {
          console.error("Towing requests Realtime error:", status, error);
        }
  ...
  if (checkingAccess) {
    return <CenteredMessage>Se verifică accesul...</CenteredMessage>;
  }
  ...
  return (
    <main className="min-h-screen bg-black px-6 py-10 text-white">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold md:text-4xl">
              Tractări disponibile
            </h1>
            <p className="mt-3 max-w-2xl text-white/70">
              Verifică locul de preluare, destinația și starea vehiculului.
            </p>
          </div>
        ...
        {loadingRequests ? (
          <ListMessage>Se încarcă lucrările...</ListMessage>
        ) : dataError ? (
          <ListMessage>
          ...
          <ListMessage>
            <h2 className="text-2xl font-semibold">
              Nu există tractări disponibile
            </h2>
            <p className="mt-3 text-white/70">
              Când un client postează o cerere de tractare, aceasta va apărea
              aici.
            </p>
            <button
              type="button"
                ...
                >
                  <CarHeader
                    ...
                    details={[
                      ...
                      {
                        text: getRequestTypeBadgeLabel("towing"),
                        color: "orange",
                      },
                      {
